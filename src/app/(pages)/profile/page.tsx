            ...
            {user ?
              ...
              <div className="w-full">
                <div className="w-[200px] h-[200px] mb-10">
                  <Image src={user.picture?? ''} alt={'Изображение профиля'} width={200} height={200} className='w-full h-full rounded-sm object-cover border border-zinc-800'/>
                </div>
                <ul className='flex flex-col w-full'>
                  <li className=''>
                    <h3 className='mb-2 h3'>{user.given_name}</h3>
                    <p className='text-xl'>{user.family_name}</p>
                  </li>
                  <li className='mt-20'>
                    <p className="">Emal: {user.email}</p>
                  </li>
                </ul>
              </div>
